...
| 04 | 2026-07-13 | task-details-display | active | - | - |
| 05 | 2026-07-13 | idea-inbox-sync | active | - | - |
...
- Should the future native task editor reuse any of the details display logic, or be fully independent? (from #04)
- Should there be a notification when ideas are synced, or should it be completely silent? (from #05)
- If the inbox file doesn't exist yet, should the workflow create it with the header, or require the user to create it first? (from #05)
